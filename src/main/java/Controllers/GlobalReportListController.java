...
public class GlobalReportListController {
    ...
    @FXML
    private TableColumn<Report, String> colId;
    @FXML
    private TableColumn<Report, String> colTitle;
    @FXML
    private TableColumn<Report, String> colUser;
    @FXML
    private TableColumn<Report, String> colDate;
    @FXML
    private TableColumn<Report, String> colDescription;
    @FXML
        ...
        txtSearch.textProperty().addListener((observable, oldValue, newValue) -> {
            filteredData.setPredicate(report -> {
                ...
                if (report.getTitle().toLowerCase().contains(lowerCaseFilter))
                    return true;
                if (report.getDescription().toLowerCase().contains(lowerCaseFilter))
                    return true;
                if (report.getUser() != null && report.getUser().getName().toLowerCase().contains(lowerCaseFilter))
                    return true;
    ...
    private void openUserManagement() {
        if (MainController.instance != null) {
            MainController.instance.openUserManagement();
        }
    }
