...
public class BackRecommandationController implements Initializable {
    ...
    private void loadData() {
        try {
            // Get all recommendations for BackOffice
            allRecommendations = serviceRecommandation.recuperer();
            updateStats();
    ...
    private VBox buildCard(Recommandation r) {
        ...
        descLabel.setStyle("-fx-text-fill: #94a3b8; -fx-font-size: 12px; -fx-line-spacing: 2;");
