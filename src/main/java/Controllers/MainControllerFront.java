...
public class MainControllerFront {
    ...
    public void openDashboard() {
        loadPage("DashboardFront.fxml", "Dashboard", "Vue d'ensemble de vos statistiques", btnDashboard);
    }

    @FXML
    public void openEnergie() {
        loadPage("EnergieViewFront.fxml", "Mon Énergie", "Suivi de consommation et performance", btnEnergie);
    }

    @FXML
    public void openRecommandations() {
        loadPage("RecommandationViewFront.fxml", "Conseils Éco", "Optimisez votre consommation intelligemment", btnRecommandations);
    }
